...
@Transactional
class CajuAuthApplicationMerchantTest {
	...
	@Test
	public void testMerchantFallback() throws JsonProcessingException, Exception {

		// Category = 0
		CreditTransactionRequestDTO request1 = new CreditTransactionRequestDTO("1", 100.0, "0000", "MEAL                        SAO PAULO BR");
	...
	@Test
	public void testMerchantCategoryWithFallback() throws JsonProcessingException, Exception {

		// Category = 1
		CreditTransactionRequestDTO request1 = new CreditTransactionRequestDTO("2", 100.0, "0000", "FOOD                        SAO PAULO BR");
	...
	@Test
	public void testCashMerchant() throws JsonProcessingException, Exception {

		// Category = 0
		CreditTransactionRequestDTO request1 = new CreditTransactionRequestDTO("1", 100.0, "0000", "CASH                        SAO PAULO BR");
